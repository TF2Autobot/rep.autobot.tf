...
export function readFile({ p, json }: { p: string; json: boolean }): Promise<any> {
...
export function writeFile({ p, data, json }: { p: string; data: unknown; json: boolean }): Promise<void> {
    return new Promise((resolve, reject) => {
        let write;
